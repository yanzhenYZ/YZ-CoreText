...
+ (id)imageNamed:(NSString *)name
{
    ...
    //获得gif的名字
//    name.lastPathComponent containsString:<#(nonnull NSString *)#>
...
- (id)initWithCGImageSource:(CGImageSourceRef)imageSource scale:(CGFloat)scale
{
    ...
    //CGImageSourceCopyProperties--图像源的属性
